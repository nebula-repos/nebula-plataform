...
export default async function AdminReleasesPage() {
  ...
  const statCards = [
    { label: copy.stats.total, value: totalReleasesCount },
    { label: copy.stats.published, value: publishedCount },
  ]
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-b from-background via-background/80 to-primary/5 py-28">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-800/22 via-cyan-600/12 to-transparent blur-3xl" />
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-12 lg:grid-cols-[minmax(0,6fr)_minmax(0,5fr)] lg:items-center">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                ...
                <Link href="/admin/releases/new">
                  <Button className="gap-2 rounded-full bg-gradient-to-r from-blue-800 via-cyan-600 to-emerald-400 text-primary-foreground shadow-xl shadow-primary/30 transition-all duration-300 hover:scale-[1.02]">
                    {copy.hero.new}
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2">
              {statCards.map((stat) => (
                ...
                >
                  <p className="text-[0.62rem] font-semibold uppercase tracking-[0.4em] text-primary/80">{stat.label}</p>
                        ...
                        <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                          <div className="space-y-3">
                            <div className="flex flex-wrap items-center gap-2">
                              <p className="text-lg font-semibold text-foreground">{release.title}</p>
                              <Badge
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              <Button
                                variant="outline"
                                size="sm"
                                className="rounded-full border-primary/50 bg-white/5 text-primary shadow-lg shadow-primary/10 transition-all duration-300 hover:border-primary hover:bg-white/10 hover:shadow-primary/25"
                              >
