          ...
          <div className="container mx-auto px-4">
            <Card className="relative mx-auto max-w-3xl overflow-hidden rounded-[32px] border border-white/10 bg-background/90 shadow-[0_60px_140px_-80px_rgba(15,15,15,0.85)] backdrop-blur">
              ...
              <CardHeader className="space-y-4">
                ...
                <div>
                  <CardTitle className="text-2xl text-foreground">{copy.editPage.cardTitle}</CardTitle>
                  <CardDescription className="text-pretty text-muted-foreground">{copy.editPage.cardDescription}</CardDescription>
                </div>
              </CardHeader>
              <CardContent>
                <ResearchLineForm
